<head>
  ...
  <script type="text/javascript">
    ...
    $(document).on("click",".btn",function(){
      var v=$(this).attr("id");
      var r=$(this).attr("rel");
      $.post("blockque.php",{v:v},function(data){
        if(r==0){
  ...
  <div class="row">
    <div class="col-md-3 ">
         <div class="list-group ">
              ...
              <a href="adminque.php" class="list-group-item list-group-item-action active">Questions</a>
                ...
                <div style="border: 1px dashed; padding: 10px; box-shadow: 5px 10px 18px red;">
                  ...
                  <?php  
                    ...
                    while($r=mysqli_fetch_array($rs)){
                      echo "<div class='inline'><a href='adminque.php?code=$r[0]'>".$r[1]."</a>";
                      if($r[4]==0){ 
